...
For maximum privacy, use the local npm package:
    ...
    npx @ansvar/finnish-standards-mcp
...
- Contains **only** publicly available data from authoritative Finnish government sources

## Data Sources

All data in this MCP is sourced from publicly available Finnish government
